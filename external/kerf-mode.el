...
(defun kerf-font-lock-keyword-maker ()
  '( ("^\\(//\\)\\([^\n]*\\)$" 
    ...
    ("[!#$%&*+,.;<=/>?@^|~-:]:?" . 'kerf-builtin-face)
("\\<\\(abs\\|acos\\|add\\|and\\|ascend\\|asin\\|asof_join\\|atan\\|atlas\\|atom\\|avg\\|between\\|btree\\|bucketed\\||car\\|cdr\\|ceil\\|char\\|close_socket\\|cos\\|cosh\\|count\\|count_nonnull\\|count_null\\|create_table_from_csv\\|create_table_from_psv\\|create_table_from_tsv\\|deal\\|def\\|delete_keys\\|descend\\|dir_ls\\|display\\|distinct\\|divide\\|dlload\\|dotp\\|drop\\|enlist\\|enum\\|enumerate\\|equal\\|equals\\|erf\\|erfc\\|eval\\|except\\|exit\\|exp\\|explode\\|first\\|flatten\\|float\\|floor\\|function\\|global\\|globals\\|greater\\|greatereq\\|has_column\\|hash\\|hashed\\|has_key\\|ident\\|ifnull\\|implode\\|in\\|index\\|indexed\\|int\\|intersect\\|isnull\\|join\\|json_from_kerf\\|kerf_from_json\\|kerf_type\\|kerf_type_name\\|KEY\\|last\\|left_join\\|len\\|less\\|lesseq\\|lg\\|lines\\|ln\\|load\\|log\\|lsq\\|map\\|match\\|mavg\\|max\\|maxes\\|mcount\\|meta_table\\|min\\|mins\\|minus\\|minv\\|mkdir\\|mmax\\|mmin\\|mmul\\|mod\\|msum\\|negate\\|negative\\|ngram\\|NONNULL\\|not\\|noteq\\|noteq\\|now\\|now_date\\|now_time\\|open_socket\\|open_table\\|or\\|order\\|out\\|part\\|plus\\|pow\\|PRIMARY\\|rand\\|range\\|read_from_path\\|read_striped_from_path\\|read_table_from_csv\\|read_table_from_delimited_file\\|read_table_from_fixed_file\\|read_table_from_tsv\\|rep\\|repeat\\|reserved\\|reverse\\|rsum\\|run\\|search\\|seed_prng\\|send_async\\|send_sync\\|setminus\\|shift\\|shuffle\\|sin\\|sinh\\|sleep\\|sort\\|sort_debug\\|split\\|sqrt\\|stamp_diff\\|std\\|string\\|subtract\\|sum\\|system\\|tables\\|take\\|tan\\|tanh\\|times\\|timing\\|tolower\\|toupper\\|transpose\\|trim\\|type_null\\|uneval\\|union\\|unique\\|UNIQUE\\|var\\|which\\|write_csv_from_table\\|write_delimited_file_from_table\\|write_striped_from_path\\|write_text\\|write_to_path\\|xbar\\|xkeys\\|xvals\\)\\>"  . 'kerf-builtin-face)
    ("[{}]" . 'kerf-brace-face)
    ("[][]" . 'kerf-bracket-face)
    ("[)(]" . 'kerf-bracket-face)))
